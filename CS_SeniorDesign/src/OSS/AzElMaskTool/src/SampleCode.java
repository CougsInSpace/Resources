...
public class SampleCode
{
	...
	throws Throwable
	{
		this.m_AgStkObjectRootClass.executeCommand("VO */Satellite/" + data.SatelliteName + "/Sensor/" + data.SensorName + " AzElmaskTool Time \""+data.ReportTime+"\"");
		this.m_AgStkObjectRootClass.executeCommand("VO */Satellite/" + data.SatelliteName + "/Sensor/" + data.SensorName + " AzElmaskTool Object On Satellite/" + data.SatelliteName);    
		this.m_AgStkObjectRootClass.executeCommand("VO */Satellite/" + data.SatelliteName + "/Sensor/" + data.SensorName + " AzElmaskTool File \"" + data.ReportName + "\"");
		this.m_AgStkObjectRootClass.executeCommand("VO */Satellite/" + data.SatelliteName + "/Sensor/" + data.SensorName + " AzElmaskTool Compute")	;
	}
}