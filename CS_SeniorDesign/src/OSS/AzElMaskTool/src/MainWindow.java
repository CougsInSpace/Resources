...
implements ActionListener, IAgMsgViewerJToolBarEventsListener
{
	...
	private final static String		s_TITLE				= "AzElMaskTool";
	...
	throws Throwable
	{
		...
		this.m_AgGfxAnalysisCntrlClass = new AgGfxAnalysisCntrlClass(300, 300);
		this.m_AgGfxAnalysisCntrlClass.setControlMode(AgEGfxAnalysisMode.E_AZ_EL_MASK_TOOL);
	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			...
			if(ae.getActionCommand().equalsIgnoreCase(SampleJPanel.s_STEP1_CREATESCENARIO_TEXT))
			{
				...
				SampleData data = this.m_SampleCode.getSampleData();
