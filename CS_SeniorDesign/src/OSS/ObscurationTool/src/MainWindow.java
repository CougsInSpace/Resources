...
implements ActionListener, IAgMsgViewerJToolBarEventsListener
{
	...
	private final static String		s_TITLE				= "CustomApp_AWT_STK_X_GfxAnalysis_ObscurationTool";
	...
	throws Throwable
	{
		...
		this.m_AgGfxAnalysisCntrlClass.setControlMode(AgEGfxAnalysisMode.E_OBSCURATION_TOOL);
